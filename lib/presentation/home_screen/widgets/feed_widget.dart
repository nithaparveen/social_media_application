                ...
                child: Card(
                  child: Column(
                    children: [
                      ListTile(
                          leading: CircleAvatar(
                            backgroundImage: hcontrol.homeModel.data?[index]
                                        .author?.profileImage ==
                                    null
                                ? NetworkImage(
                                    "https://th.bing.com/th/id/OIP.y6HMdOJ4LiIUWk7n5ZGlpAHaHa?w=480&h=480&rs=1&pid=ImgDetMain")
                          ...
                          children: [
                            Wrap(
                              children: [
                                ...
                                displayText(
                                    label:
                                        "${hcontrol.homeModel.data?[index].likeCount}"),
                              ],
                            ),
                            Wrap(
                              children: [
                                displayText(
                                    label:
                                        "${hcontrol.homeModel.data?[index].commentsCount}"),
                                SizedBox(width: size.width * .02),
                                displayText(label: "Comments"),
                              ],
                            )
                      ...
                      Row(
                        ...
                        children: [
                          headerButton(
                              buttonText: "Like",
                              buttonIcon:
                                  hcontrol.homeModel.data?[index].isLiked ==
                                          true
